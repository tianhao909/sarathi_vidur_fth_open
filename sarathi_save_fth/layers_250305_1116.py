...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        print(f"++fth VocabParallelEmbedding all reduce comm size= {output_parallel.element_size() * output_parallel.nelement()} bytes")
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        print(f"++fth ColumnParallelLinear all gather comm size= {output_parallel.element_size() * output_parallel.nelement()} bytes")
...
class RowParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        print(f"++fth cRowParallelLinear all reduce comm size= {output_parallel.element_size() * output_parallel.nelement()} bytes" )
